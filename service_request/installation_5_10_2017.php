...
?>
  ...
  ?>
        ...
        <td align="center">&nbsp;<?php echo $query[$i]['installation_approve'];?></td>
        ...
        {?>
         ...
         {?>
          ...
          <?php 
        if($query[$i][" "]!="" && ($query[$i]["sales_comment"]=="" || $query[$i]["installation_status"]==7))
          {?>
...
?>
   ...
   <!--       $reqByList=mysql_query("select request_by from installation_request where request_by in(select name from sales_person)");  -->


       <?php 

          if($query[$i]["installation_status"] == 8 || $query[$i]["installation_status"] == 1) 
            {
               if($query[$i]["instal_reinstall"]=='online_crack')
                ...
                <?php
                 ...
                 if(($query[$i]["instal_reinstall"]=='installation') || ($query[$i]["instal_reinstall"]=='crack'))
                 {
                  ?>
