...
function req_info()
{
 ...
 if(document.form1.Zone_area.value=="")
  ...
  return false;
    ...
    var cnumber=document.form1.contact_number.value;
    if(cnumber!="")
        {
 ...
 -->
   ...
   <!--   <TD height="32" align="right"><INPUT type="checkbox" name="chk"/></TD> -->
           ...
           <td height="32" align="right">Contact Number:*</td>
            <td><input type="text" name="contact_number[]" id="contact_number" maxlength="10" value="<?=$result['contact_number']?>" style="width:147px"/>
           </td>       
    </tr>
