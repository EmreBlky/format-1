...
.label { color:#000; font-size:16px;}
 ...
 <form method="post" action="" name="form1" onSubmit="return req_info();">
    <table style="padding-left: 100px;width: 500px;border:1px solid #000;" cellspacing="5" cellpadding="5">
      <tr>
       ...
       <tr>
        ...
        <td width="54%"><input type="checkbox" name="required" id="required" value="urgent" <?php if($result[0]['required']=='urgent') {?> checked="checked" <? }?> />
        </td>
      </tr>
      <tr>
  ...
  <tr>
     ...
     <tr>
        ...
        <td><input type="text" name="location"  id="location" value="<?=$result[0]['location']?>"/></td>
    </tr> 
     ...
     <table style="padding-left: 700px;width: 800px;" cellspacing="5" cellpadding="5">
      ...
      <tr>
            ...
            onchange="designationChange(this.value)">
                ...
                <option value="supervisor"  <? if($result[0]['designation']=='supervisor') {?> selected="selected" <? } ?> >Supervisoer</option>
    ...
    <tr>
           ...
           <td height="32" align="right">Contact Number:</td>
            <td><input type="text" name="contact_number[]" id="contact_number" value="<?=$result[0]['alter_contact_no']?>" style="width:147px"/>
           </td>       
      </tr>
  </table>
