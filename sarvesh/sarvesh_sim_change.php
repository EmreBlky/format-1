...
mysql_query("Update sim_change set old_sim_status!=\"\" where id ='".$chk_id[$i]."'");
...
$query = mysql_query("SELECT * FROM sim_change where old_sim!=\"\" and old_sim_status=\"\" order by id desc LIMIT $start,$end");   
...
<td><?php echo $i?></td>
  ...
  <td><?php echo $row["new_sim"];?></td>
	...
	<td><a href="sarvesh_update_sim_change.php?id=<?php echo $row['id'];?>">Edit</a></td>
