	...
	if(deviceModel != '')
	{
		if((actype == 'Paid' || actype == 'POC(Paid Demo)') && (payment == 'Billed' || payment == 'CashClient'))
		{
			if(deviceModel == 8 && dPrice<5000)
			{
				...
				alert('Pointer Model Price Never Less than 5000RS.');
				return false;
			}
			else if(deviceModel != 8 && dPrice<4000)
			{
				document.getElementById(dStatus).disabled=true;
				document.getElementById(dStatustwo).disabled=true;
				...
				document.getElementById(dTotal).value = '';
				document.getElementById(deviceVal).value = '';
				alert('All Model Price Never Less than 4000RS.');
				return false;
			}
			else
			{
	...
	if(deviceModel != '')
	{
		if((actype == 'Paid' || actype == 'POC(Paid Demo)') && (payment == 'Billed' || payment == 'CashClient'))
		{
			if(rPrice<250)
			{
				...
				alert('Rent Price Never Less than 250RS.');
				return false;
			}
			else
			{
