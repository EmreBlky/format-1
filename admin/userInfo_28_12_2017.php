...
if(isset($_GET['action']) && $_GET['action']=='InstallationApproveOtherModel')
{
	...
	$SelectStockView=select_query("select * from internalsoftware.admin_stock_view where device_type_id='".$otherModelId."' and dispatch_branch='".$branchId."'");
	$SelectPreviosStockView=select_query("select * from internalsoftware.admin_stock_view where device_type_id='".$previousModelId."' and dispatch_branch='".$branchId."'");
...
if(isset($_GET['action']) && $_GET['action']=='Installationapprove')
{
	...
	$queryAdminStock = "SELECT * FROM internalsoftware.admin_stock_view where device_type_id='".$deviceModel."' and device_parent_id='".$deviceType."' and dispatch_branch='".$branch_id."' and update_device_status='1'";
	$rowQueryAdminStock=select_query($queryAdminStock);
	//print_r($rowQueryAdminStock);die;

	$queryAdminStockHistory = "SELECT * FROM internalsoftware.admin_stock_approved_history where installation_req_id='".$row_id."'";
	...
	if($adminapproval<=$TotalDeviceAvilable){
		if($approveModel==0){
			if($adminapproval<=$TotalNewDevice){
				...
				$UpdateApprovalstatus=select_query("update internalsoftware.admin_stock_view set new_device='".$TotalNewDevice."',total_device='".$adminApproved."' where device_type_id='".$deviceModel."' and device_parent_id='".$deviceType."' and dispatch_branch='".$branch_id."' and update_device_status='1'");
				//echo "insert into internalsoftware.admin_stock_approved_history(installation_req_id,device_type_id,device_parent_id,ffc_device_approved,new_device_approved,total_device,branch_device,update_device_status,approve_date,previousModel) values('".$row_id."','".$deviceModel."','".$deviceType."','0','".$adminapproval."','".$adminApproved."','".$branch_id."','".$rowQueryAdminStock[0]['update_device_status']."',now(),'".$previousModel."'";die;
				$InsertHistoryAdminApproved=select_query("insert into internalsoftware.admin_stock_approved_history(installation_req_id,device_type_id,device_parent_id,ffc_device_approved,new_device_approved,total_device,branch_device,update_device_status,approve_date,previousModel) values('".$row_id."','".$deviceModel."','".$deviceType."','0','".$adminapproval."','".$adminApproved."','".$branch_id."','".$rowQueryAdminStock[0]['update_device_status']."',now(),'".$previousModel."')");

				// $query = "SELECT * FROM internalsoftware.installation_request  where id=".$row_id;
				// $row=select_query($query);
				/* if($row[0]["branch_id"]==1){*/
				$Updateapprovestatus="update internalsoftware.installation_request set approved_model='".$deviceModel."',installation_status=9, approve_status=1, installation_approve='".$adminapproval."', approve_date='".date("Y-m-d H:i:s")."' where id=".$row_id;
				/*}
				else{
			...
			if($adminapproval<=$TotalFFCDevice){
				...
				$adminApproved = $TotalDeviceAvilable-$adminapproval; // Remain Total device
				$UpdateApprovalstatus=select_query("update internalsoftware.admin_stock_view set ffc_device='".$TotalFFCDevice."',total_device='".$adminApproved."' where device_type_id='".$deviceModel."' and device_parent_id='".$deviceType."' and dispatch_branch='".$branch_id."' and update_device_status='1'");
				//echo "insert into internalsoftware.admin_stock_approved_history(installation_req_id,device_type_id,device_parent_id,ffc_device_approved,new_device_approved,total_device,branch_device,update_device_status,approve_date,previousModel) values('".$row_id."','".$deviceModel."','".$deviceType."','0','".$adminapproval."','".$adminApproved."','".$branch_id."','".$rowQueryAdminStock[0]['update_device_status']."',now(),'".$previousModel."'";die;
				$InsertHistoryAdminApproved=select_query("insert into internalsoftware.admin_stock_approved_history(installation_req_id,device_type_id,device_parent_id,ffc_device_approved,new_device_approved,total_device,branch_device,update_device_status,approve_date,previousModel) values('".$row_id."','".$deviceModel."','".$deviceType."','".$adminapproval."','0','".$adminApproved."','".$branch_id."','".$rowQueryAdminStock[0]['update_device_status']."',now(),'".$previousModel."')");
			...
			if($adminapproval==$totalApproved){
				...
				if($TotalNewDevice == 0){
					...
					$UpdateApprovalstatus=select_query("update internalsoftware.admin_stock_view set new_device='".$TotalNewDevice."',ffc_device='".$TotalFFCDevice."',total_device='".$adminApproved."' where device_type_id='".$deviceModel."' and device_parent_id='".$deviceType."' and dispatch_branch='".$branch_id."' and update_device_status='1'");
					//echo "insert into internalsoftware.admin_stock_approved_history(installation_req_id,device_type_id,device_parent_id,ffc_device_approved,new_device_approved,total_device,branch_device,update_device_status,approve_date,previousModel) values('".$row_id."','".$deviceModel."','".$deviceType."','0','".$adminapproval."','".$adminApproved."','".$branch_id."','".$rowQueryAdminStock[0]['update_device_status']."',now(),'".$previousModel."'";die;						
					$InsertHistoryAdminApproved=select_query("insert into internalsoftware.admin_stock_approved_history(installation_req_id,device_type_id,device_parent_id,ffc_device_approved,new_device_approved,total_device,branch_device,update_device_status,approve_date,previousModel) values('".$row_id."','".$deviceModel."','".$deviceType."','".$ffcDeviceApprove."','".$newDeviceApprove."','".$adminApproved."','".$branch_id."','".$rowQueryAdminStock[0]['update_device_status']."',now(),'".$previousModel."')");
			...
			{
				echo "Please Check No. of Approve Device";
			}
		...
		echo $errMsg = "Stock not available this model";
	}
}
