...
$s(document).ready(function(){
   ...
   $s('#main_user_id').attr("disabled", true); 
     ...
     $s('#instal_reinstall2').attr("disabled", true); 
     $s('#instal_reinstall1').attr("disabled", true);
        // $s('#accessTable').attr("disabled", true);
...
if($action=='edit' or $action=='editp')
    {
     // $toolName=array();
      ...
      // echo '<pre>'; print_r($result); die;
        ...
        $model_id = $result[0]["model"];
        $dev_type = $result[0]["device_type"];
        $instal_reinstall = $result[0]["instal_reinstall"];
        //echo $instal_reinstall; die;
...
if(isset($_POST['submit']))
{
   //echo '<pre>'; print_r($_POST);die;
    ...
    //echo "<pre>";print_r($accessories_tollkits);die;
   ...
   // $billing = $_POST['billing'];
    ...
    if(($instal_reinstall=='installation') && ($installation_status==3))
    {
  ...
  $rent_status = $_POST["rent_status"];
    ...
    {           
        ...
        { //echo $atime_status;
            ...
            $sql="update $internalsoftware.installation_request set time='".$time."',totime='".$totime."',atime_status='".$atime_status."', model='".$model."', contact_number='".$contact_number."', accessories_tollkit='".$accessories_tollkits."',contact_person='".$contact_person."',Zone_area='".$Area."',inter_branch='".$city."', location='".$branchLocation."',branch_type='".$branch_type."',  veh_type='".$veh_type."',required='".$required."',designation='".$designation."',alt_designation='".$alt_designation."',alt_cont_person='".$alt_cont_person."',standard='".$del_nodelux."',actype='".$actype."',MachineType='".$MachineType."',TruckType='".$TruckType."',TrailerType='".$TrailerType."',alter_contact_no='".$alt_cont_number."',model_parent='".$model_parent."', landmark='".$location."',installation_status='".$installation_status."' where id='".$id."'"; 
              //echo $sql; die;      
              $execute=mysql_query($sql);
...
function req_info()
{
 ...
 // alert(document.forms["form1"]["inter_branch"].value);
  ...
  for(var m=0; m<DrowCount; m++)
  {
    ...
    {
      var contact_person = 'contact_person'+fcounter;
...
/*border:1px solid #000;*/
 ...
 <form method="post" action="" name="form1" onSubmit="return req_info();">
    <table style="padding-left: 100px;width: 500px;" cellspacing="5" cellpadding="5">
      <tr>
       ...
       <tr>
        ...
        <td><input type="radio" name="instal_reinstall"  value="installation" readonly id="instal_reinstall1" <?php if($result[0]['instal_reinstall']=='installation') {echo "checked=\"checked\""; }?> />
          New
          <input type="radio" name="instal_reinstall" value="crack" readonly id="instal_reinstall2" <?php if($result[0]['instal_reinstall']=='crack') {echo "checked=\"checked\""; }?>" "/>
          Crack </td>
    </tr>
   ...
   <!--  <tr>
      ...
      <tr>
        <td  align="right"> Client User Name:<font color="red">* </font></td>
        <td><select name="main_user_id" id="main_user_id"  onchange="getCompanyName(this.value,'TxtCompany');"  >
...
<!-- 
 ...
 -->
      ...
      <tr>
        <td colspan="2">
          <table  id="branchlocation"  align="right"  style="width: 100%;display:none;margin-right:-5%;" cellspacing="5" cellpadding="5">
            <tr>
    ...
    <tr>
      <td colspan="2">
          <table  id="TillTime" align="left" style="width:100%;display:none;margin-left:12%;"  cellspacing="5" cellpadding="5">
            <tr>
          ...
          <table  id="BetweenTime" align="left" style="width:100%;display:none;margin-left:7.5%;"  cellspacing="5" cellpadding="5">
            <tr>
    ...
    <tr>
           ...
           <tr id="dataDesignation" <? if($result[0]['alt_designation']=='') {?> style="display:none"  <? }else { echo 'style=""'; } ?>>  
                ...
                onchange="designationChange(this.value)">
                    ...
                    <option value="others"  <? if($result[0]['alt_designation']=='others') {?> selected="selected" <? } ?>>Others</option>
                            ...
                            <td><input type="text" name="contact_person2" placeholder="Contact Person" id="contact_person2" pattern="[a-zA-Z]{3,}" title="Please enter only Characters" value="<?=$result[0]['alt_cont_person']?>" style="width:147px"/>
            </td>
      ...
      <tr>
        <td colspan="2">
           <table style=" padding-left: 6%;width: 50%;" cellspacing="5" cellpadding="5">
      <tr>
...
<script>StatusBranch12("<?=$result[0]['branch_type'];?>");
StatusBranch("<?=$result[0]['branch_type'];?>");TillBetweenTime12("<?=$result[0]['atime_status'];?>");
vehicleType("<?=$result[0]['veh_type'];?>");standardType("<?=$result[0]['standard'];?>");aclux("<?=$result[0]['actype'];?>")</script>
