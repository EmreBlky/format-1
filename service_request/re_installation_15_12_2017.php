          ...
          if($atime_status=="Till")
          {
            ...
            if($atime_status=="Between")
            {
                ...
                //1-New,2-assigned,3-newbacktoservice,4-backtoservice,5-close,6-callingclose
                 ...
                 required,branch_id, installation_status,Zone_area, atime_status,`inter_branch`, branch_type, instal_reinstall,designation,device_type,alter_contact_no,billing,TrailerType,TruckType,MachineType,actype,standard,alt_cont_person,alt_designation,acess_selection,landmark,assign_imei,device_current_location) VALUES('".$date."','".$account_manager."','".$sales_person_id."', '".$main_user_id."', '".$company."',
                 '".$no_of_vehicals."','".$status."','".$branchLocation."','".$model."','".$time."','".$totime."','".$contact_number."',now(),1,'".$contact_person."','".$veh_type."','".$required."',
                 '".$_SESSION['BranchId']."','".$installation_status."','".$Area."','".$atime_status."','".$city."','".$branch_type."',
                 '".$instal_reinstall."','".$designation."','".$deviceType."','".$contact_number2."','".$billing."','".$TrailerType."','".$TruckType."','".$MachineType."','".$actype."','".$del_nodelux."','".$contact_person2."','".$designation2."','".$acess_selection."','".$landmark."','".$arrDeviceIMEIStr."','".$deviceCurrentStatus."')";
...
/*td{ border :1px solid#000; }*/
 ...
 <form method="post" action="" name="form1" onSubmit="return req_info();" autocomplete="off">
    ...
    <!-- <tr>
     ...
     <tr>
        <td align="right" nowrap> v:<font color="red">*</font></td>
          ...
          $.ajax({
            ...
            success:function(msg){
             ...
             if(msg != 'null'){
               ...
               if(d_status == 1)
               {
                 $('#no_of_installation').prop('disabled', false);
               ...
               {
                  $('#no_of_installation').prop('disabled', 'disabled');
...
$.ajax({
    ...
    success:function(msg){
      ...
      var tblBodyData='<input type="checkbox" id="toggle" value="select" onClick="selectAllAccessory(this)"  name="acess_all"  id="acess_all" checked/>Select All <br />';
      ...
      $("#toolkitAccessory_td").show()
      $("#toolkitAccessory").html(tblBodyData)
