...
mysql_query("Update device_change set sim_old!=\"\" and sim_new!=\"\" where id ='".$chk_id[$i]."'");
...
<?php
 ...
 $num=mysql_num_rows(mysql_query("SELECT * FROM device_change order by id desc"));
...
$query = mysql_query("SELECT * FROM device_change where sim_old=\"\"  and sim_new=\"\" and pay_status!=\"\" and device_old_paid_unpaid!=\"\" order by id desc   LIMIT $start,$end");   
?>
<br />
<br />
...
<td><?php echo $i?></td>
  ...
  <td><a href="anoop_update.php?id=<?php echo $row['id'];?>">Edit</a></td>
