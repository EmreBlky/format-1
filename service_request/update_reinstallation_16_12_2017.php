...
{ //echo $_POST['Zone_area'];
    ...
    //echo "SELECT id,`name` FROM re_city_spr_1_copy WHERE `name`='".$_POST['Zone_area']."'";
...
{  
  ...
  // return false;
  // }
   var contactPerson=document.form1.contact_person.value;
  ...
  // return false;
  // }
    var contactNumber=document.form1.contact_number.value;
  ...
  else
  {
    ...
    // return false;
    // }
     var contactPerson2=document.form1.contact_person2.value; 
    ...
    if(contactPerson2 == "" || contactPerson2 == null){
      ...
      var contactNumber=document.form1.contact_number2.value;
 ...
 <form method="post" action="" name="form1" onSubmit="return req_info();" autocomplete="off">
     ...
     <tr>
      ...
      <tr>
        ...
        <td nowrap>
          ...
          <h3><?php  echo $result[0]['assign_imei']; ?></h3>
          ...
          <tr>
            ...
            <td>
              ...
              for($i=0;$i<count($toolName);$i++){?>
                <input type="checkbox" checked onclick="return false;" name="toolkit[]" value="<?=$toolName[$i]['item_id']?>"><?php echo $toolName[$i]['item_name']."<br>"; ?>
              <?php } ?>
              </div>
            </td>
          </tr>
  ...
  <!--   
    ...
    <tr>
      ...
      <tr>
        <td colspan="2">
          <span style="width:8px;margin-left:77px;align:right">Location:*&#160;&#160;&#160;&#160;&#160;</span><input type="text" name="Zone_area" id="Zone_area" style="width:24%;border-radius: 5px;padding:2px;" value="<?php echo $area[0]["name"];?>" /> 
         ...
         if(keyword.length)
         {
             ...
             else
             {
                switch (event.keyCode)
                {
                 ...
                 case 13:
                    $("#ajax_response").fadeOut("slow");
                    $("#Zone_area").val($s("li[class='selected'] a").text());
                 break;
                }
             }
         }
