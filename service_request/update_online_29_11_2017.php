...
if($action=='edit' or $action=='editp')
    {
        ...
        $devicelList = select_query("SELECT distinct dp.item_id as device_id,dp.item_name as deviceType from new_account_model_master as newmodel inner join item_master as dp ON newmodel.device_type=dp.item_id WHERE newmodel.new_account_reqid='".$result[0]['user_id']."'");

        $devModelList = select_query("SELECT dm.item_id as model_id,dm.item_name as model_name from new_account_model_master as newmodel inner join item_master as dm  ON newmodel.device_model=dm.item_id WHERE newmodel.new_account_reqid='".$result[0]['user_id']."' and dm.parent_id='".$result[0]['device_type']."'");
 ...
 <!--    <tr>
    ...
    <tr>
      ...
      <tr>
        <td colspan="2">
          <table  id="branchlocation"  align="right"  style="width: 100%;display:none;margin-right:-2%;" cellspacing="5" cellpadding="5">
            <tr>
              <td align="left" style="width: 18%;margin-right:17px;" >Branch Location:<font color="red">* </font></td>
      ...
      <tr>
        ...
        <td><input type="text" name="Zone_area" id="Zone_area" value="<?php echo $area[0]["name"];?>" style="width:30%;border-radius: 5px;padding:2px;" />
          <div id="ajax_response"></div></td>
      </tr>
      
     <tr>
        <td align="right"> LandMark:<font color="red">* </font></td>
        <td><input type="text" name="location"  id="location" value="<?=$result[0]['landmark']?>" minlength="15" style="width:30%;border-radius: 5px;padding:2px;" /></td>
    </tr> 
      ...
      <td colspan="2">
          <table  id="TillTime" align="left" style="width:100%;display:none;margin-left:11%;"  cellspacing="5" cellpadding="5">
            <tr>
              ...
              <td><input type="text" name="time" id="datetimepicker" value="<?php echo date("Y/m/d H:i",strtotime($result[0]['time']))?>" style="width:110%;border-radius: 5px;padding:2px;"/></td>
            </tr>
          </table>
          <table  id="BetweenTime" align="left" style="width:100%;display:none;margin-left:6%;"  cellspacing="5" cellpadding="5">
            <tr>
              <td align="right">From Time:*</td>
              <td><input type="text" name="time1" id="datetimepicker1" value="<?php echo date("Y/m/d H:i",strtotime($result[0]['time']))?>" style="width:110%;border-radius: 5px;padding:2px;"/></td>
            </tr>
            <tr>
              <td align="right">To Time:*</td>
              <td><input type="text" name="totime" id="datetimepicker2" value="<?php echo date("Y/m/d H:i",strtotime($result[0]['totime']))?>" style="width:110%;border-radius: 5px;padding:2px;"/></td>
            </tr>
          </table>
        </td>
    </tr>
    <tr>
        <td align="right" valign="top">Contact Details<font color="red">* </font></td></td>
        <td style="margin-left:20px;">
          ...
          <table id="dataTable"  cellspacing="2" cellpadding="2">
           <tr>
                ...
                <td>
                  <input type="text" name="contact_person[]" id="contact_person" pattern="[A-Za-z0-9]+" value="<?=$result[0]['contact_person']?>" style="width:147px;border-radius: 5px;padding:2px;"/>
                </td>

                <td>
                  <input type="text" name="contact_number[]" id="contact_number" value="<?=$result[0]['contact_number']?>" style="width:147px;border-radius: 5px;padding:2px;"/>
               </td>        
           </tr>

           <tr id="dataDesignation" <? if($result[0]['alt_designation']=='') {?> style="display:none;border:1px solid #000;" > <? }else { echo 'style="border:1px solid #000;"'; } ?> > 
                <td  height="32" align="right">
                  <select name="designation2" id="designation2"  onchange="designationChange(this.value)">
                    <option value="">-- Select Designation --</option>
                ...
                <td>
                  <input type="text" name="contact_person[]" id="contact_person" pattern="[A-Za-z0-9]+" value="<?=$result[0]['alt_cont_person']?>" style="width:147px;border-radius: 5px;padding:2px;"/>
                </td>
                <td>
                  <input type="text" name="contact_number2" placeholder="Contact Number" id="contact_number2"  minlength="10" maxlength="10" value="<?=$result[0]['alter_contact_no']?>"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'  style="width:147px;border-radius: 5px;padding:2px;"/>
                </td>       
           </tr>
          </table>
