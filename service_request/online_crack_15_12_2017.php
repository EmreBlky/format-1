   ...
   // }
    ...
    { 
      if($atime_status=="Till")
      {
              ...
              '".$instal_reinstall."','".$designation."','".$deviceType."','".$alt_cont_number."','".$billing."','".$TrailerType."','".$TruckType."','".$MachineType."','".$actype."','".$del_nodelux."','".$alt_cont_person."','".$alt_designation."','".$location."','1','".$no_of_vehicals."','".$accessories_tollkits."')";
              //echo $sql; die;
        ...
        if($atime_status=="Between")
        {
           ...
           // $totime=$_POST['totime'];
            ...
            //1-New,2-assigned,3-newbacktoservice,4-backtoservice,5-close,6-callingclose
             ...
             required,branch_id, installation_status,Zone_area, atime_status,`inter_branch`, branch_type, instal_reinstall,designation,device_type,alter_contact_no,billing,TrailerType,TruckType,MachineType,actype,standard,alt_cont_person,alt_designation,landmark,approve_status,installation_approve,accessories_tollkit) VALUES('".$date."','".$account_manager."','".$sales_person_id."', '".$main_user_id."', '".$company."',
...
td{
 ...
 <form method="post" action="" name="form1"   autocomplete="off" onSubmit="return req_info(); ">
  ...
  <!--   <tr>
     ...
     <tr>
        ...
        <td nowrap>
          <select style="width:150px;" name="main_user_id" id="main_user_id"  onchange="showUser(this.value,'ajaxdata'); getCompanyName(this.value,'TxtCompany');getSalesPersonName(this.value,'TxtSalesPersonName'); getdevicetype(this.value,'deviceType');gettoolkit(this.value);" />
 ...
 <!-- <tr>
        ...
        <td><textarea id="toolkitAccessory"></textarea></td>
    </tr> -->
   <!--  <tr>
