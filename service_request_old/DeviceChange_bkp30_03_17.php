...
$page=$_POST['page'];
        ...
        if($action=='edit' or $action=='editp')
        {
                ...
                $ffc_query= mssql_query("select imei_no,old_client_name,ffc_date,old_veh from device_replace_ffc where replace_device_imei='".$client_imei."' order by replaced_date desc");
            ...
            <tr>
             ...
             <tr>
                ...
                <td><select name="Device_type" id="Device_type" onchange="NewOldDeviceDiv(this.value)" >
                    ...
                    <?php if($ffc_count > 0){ $ffc_value = "FFC";?>
            ...
            <td colspan="2" align="center">
             ...
             <table  id="FFCDevice" align="center" style="width: 500px;display:none;border:1"  cellspacing="5" cellpadding="5">
               ...
               <!-- <tr>
                ...
                <tr>
                <td> <label id="lblDmodel">Device IMEI</label></td>
                <td> <input type="text" name="rdd_ffc_device_imei" id="rdd_ffc_device_imei" value="<?=$ffc_details['imei_no']?>" readonly="readonly" /></td>
                </tr>
                <tr>
                <td> <label id="lblDmodel">FFC User Name</label></td>
                <td> <input type="text" name="last_ffc_user" id="last_ffc_user" value="<?=$ffc_details['old_client_name']?>" readonly="readonly" /></td>
                </tr>
                <tr>
                <td> <label id="lblDmodel">FFC Vehicle No</label></td>
                <td> <input type="text" name="ffc_veh" id="ffc_veh" value="<?=$ffc_details['old_veh']?>" readonly="readonly" /></td>
                </tr>
                <tr>
                <td> <label id="lblDmodel">FFC Date</label></td>
                <td> <input type="text" name="ffc_date" id="ffc_date" value="<?=$ffc_details['ffc_date']?>" readonly="readonly" /></td>
                </tr>
                 <tr>
                <td class="style2">
                    Billing</td>
