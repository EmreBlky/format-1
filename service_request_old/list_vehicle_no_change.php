        ...
        <td><?php if($_POST["Showrequest"]!=1 && $_POST["Showrequest"]!=2)
			{
				...
				{
					if($_SESSION['username']=='saleslogin')
					{
						/*|| $_SESSION['username']=='asaleslogin' || $_SESSION['username']=='msaleslogin' || $_SESSION['username']=='jsaleslogin' || $_SESSION['username']=='ksaleslogin'*/
