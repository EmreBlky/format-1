...
?>
        ...
        <td><strong>
            <?     if($query[0]["sim_change_status"]==2 || ($query[0]["support_comment"]!="" && $query[0]["service_comment"]==""))
        {echo "Reply Pending at Request Side";}
        elseif($query[0]["sim_change_status"]==1 && $query[0]["final_status"]!=1){echo "Pending at Tech Support Team";}
