...
include ('connection.php');
 ...
 $updt=mysql_query("update device_change set sim_old='".$_POST["sim_old"]."',sim_new='".$_POST["sim_new"]."' where id='".$_POST["id"]."'");	
     echo "record updated";
 }
   $sql=("select * from device_change where id='".$_GET["id"]."'");
...
<td><input type="value" name="id" value="<?php echo $row["id"];?>"></td>
  <td><input type="text"  name="sim_old" value=<?php echo $row["sim_old"];?> ></td>
  <td><input type="text"  name="sim_new" value=<?php echo $row["sim_new"];?>></td>
