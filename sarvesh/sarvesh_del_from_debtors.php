...
for($i=0;$i<count($chk_id);$i++){
 ...
 mysql_query("Update del_form_debtors set total_pay_rec!=\"\"   where id ='".$chk_id[$i]."'");
...
$query = mysql_query("SELECT * FROM del_form_debtors where total_pay_rec=\"\"  and date_of_creation!=\"\" and device_status!=\"\" and imei_of_removel_devices!=\"\" and reg_no!=\"\" order by id desc  LIMIT $start,$end");
?>
...
<td><?php echo $row["date"];?></td>
  ...
  <td><a href="sarvesh_update_del_from_debtors.php?id=<?php echo $row["id"];?>">Edit</a></td>
