...
$query = select_query("SELECT * FROM transfer_the_vehicle  where approve_status=0 or approve_status=2  order by id DESC");
...
{
?>
      <tr align="center" <? if( $query[$i]["support_comment"]!=""){ echo 'style="background-color:red"';} ?> >
        <td><?php echo $i+1; ?></td>
